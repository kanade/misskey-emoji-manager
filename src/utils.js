...
export function setToken(domain, emojiApiToken, driveApiToken) {
    localStorage.setItem(`emojiApiToken_${domain}`, emojiApiToken);
    localStorage.setItem(`driveApiToken_${domain}`, driveApiToken);
  }
    
  export function getToken(domain) {
    return {
      emojiApiToken: localStorage.getItem(`emojiApiToken_${domain}`),
      driveApiToken: localStorage.getItem(`driveApiToken_${domain}`)
    };
  }*/
  export function setToken(domain, emojiApiToken, driveApiToken) {
